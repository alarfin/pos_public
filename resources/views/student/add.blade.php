                        ...
                        <div class="row">
                                                ...
                                                <select name="company_branch_id" id="company_branch_id"
                                                    ...
                                                    @foreach ($company_branches as $company_branche)
                                                        <option value="{{ $company_branche->id }}"
                                                            @if (old('company_branch_id') == $company_branche->id) selected @endif>
                                        ...
                                        <div class="form-group {{ $errors->has('fathers_mobile_no') ? 'has-error' : '' }}">
                                            ...
                                            <div class="">
                                                <input type="text" class="form-control" id="fathers_mobile_no"
                                                    name="fathers_mobile_no" value="{{ old('fathers_mobile_no') }}"
                                                    autocomplete="off">
                                            </div>
                                        ...
                                        <div class="form-group {{ $errors->has('mothers_mobile_no') ? 'has-error' : '' }}">
                                            ...
                                            <div class="">
                                                <input type="text" class="form-control" id="mothers_mobile_no"
                                                    name="mothers_mobile_no" value="{{ old('mothers_mobile_no') }}"
                                                    autocomplete="off">
                                            </div>
                                        ...
                                        <div
                                            ...
                                            <div class="">
                                                <input type="text" class="form-control" id="educational_qualification"
                                                    ...
                                                    value="{{ old('educational_qualification') }}" autocomplete="off">
                                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group {{ $errors->has('photo') ? 'has-error' : '' }}">
                                    ...
                                    <div class="photo">
                                        <img id="photo_show" src="{{ asset('img/no_image.png') }}" alt="photo">
                                    </div>
                                    @error('photo')
                                        <span class="help-block">{{ $message }}</span>
                                    @enderror
                                ...
                                <div class="form-group {{ $errors->has('dob') ? 'has-error' : '' }}">
                                    ...
                                    <div class="">
                                        <input type="text" class="form-control datepicker" id="dob"
                                            name="dob" value="{{ old('dob') }}" autocomplete="off">
                                    </div>
                                    @error('dob')
                                        <span class="help-block">{{ $message }}</span>
                                    @enderror
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group {{ $errors->has('payment_method') ? 'has-error' : '' }}">
                                            ...
                                            <div class="">
                                                <select name="payment_method" id="payment_method"
                                                    ...
                                                    <option value="1"
                                                        @if (old('payment_method') == 1) selected @endif> Cash
                                                        In
                                                        Hand </option>
                                                    <option value="2"
                                                        @if (old('payment_method') == 2) selected @endif> Bank
                                                    </option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-group {{ $errors->has('fee') ? 'has-error' : '' }}">
                                            ...
                                            <div class="">
                                                <input readonly type="text" class="form-control" id="fee"
                                                    name="fee" value="{{ old('fee', 0) }}" autocomplete="off">
                                            </div>
                                            @error('fee')
                                                <span class="help-block">{{ $message }}</span>
                                            @enderror
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group {{ $errors->has('paid') ? 'has-error' : '' }}">
                                            ...
                                            <div class="">
                                                <input type="text" step="any" class="form-control" id="paid"
                                                    name="paid" value="{{ old('paid', 0) }}" autocomplete="off">
                                            </div>
                                            @error('paid')
                                                <span class="help-block">{{ $message }}</span>
                                            @enderror
                                        ...
                                        <div class="form-group {{ $errors->has('due') ? 'has-error' : '' }}">
                                            ...
                                            <div class="">
                                                <input type="text" readonly class="form-control" id="due"
                                                    name="due" value="{{ old('due') }}" autocomplete="off">
                                            </div>
                                            @error('due')
                                                <span class="help-block">{{ $message }}</span>
                                            @enderror
