        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">Price Quotation Information</h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <form method="POST"
                    action="{{ route('price_quotation_edit', ['price_quotation' => $price_quotation->id]) }}">
                    @csrf
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-3">
                                        ...
                                        <select name="company_branch_id" id="company_branch_id"
                                            ...
                                            @foreach ($branches as $branch)
                                                <option value="{{ $branch->id }}"
                                                    @if (old('company_branch_id', $price_quotation->company_branch_id) == $branch->id) selected @endif> {{ $branch->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group {{ $errors->has('customer') ? 'has-error' : '' }}">
                                    ...
                                    <select class="form-control customer" name="customer" id="customer"
                                        ...
                                        @if (old('customer', $price_quotation->id))
                                            <option value="{{ old('customer', $price_quotation->customer_id) }}" selected>
                                                @php
                                                    $customer = App\Models\Customer::find(old('customer', $price_quotation->customer_id));
                                                @endphp
                                ...
                                <div class="form-group {{ $errors->has('date') ? 'has-error' : '' }}">
                                    ...
                                    <div class="input-group date">
                                        ...
                                        <input type="text" class="form-control pull-right" id="date" name="date"
                                            value="{{ empty(old('date')) ? ($errors->has('date') ? '' : date('Y-m-d')) : old('date', $price_quotation->id) }}"
                                            autocomplete="off">
                                    </div>
                                    <!-- /.input group -->
                                ...
                                <div class="form-group {{ $errors->has('invoice_no') ? 'has-error' : '' }}">
                                    ...
                                    <div class="">
                                        <input type="text" readonly class="form-control" id="invoice_no"
                                            name="invoice_no" value="{{ old('invoice_no', $price_quotation->invoice_no) }}"
                                            autocomplete="off">
                                    </div>
                                    @error('invoice_no')
                                        <span class="help-block">{{ $message }}</span>
                                ...
                                <div class="form-group {{ $errors->has('note') ? 'has-error' : '' }}">
                                    ...
                                    <div class="">
                                        <input type="text" class="form-control" id="note" name="note"
                                            value="{{ old('note', $price_quotation->note) }}" autocomplete="off">
                                    </div>
                                    @error('note')
                                        <span class="help-block">{{ $message }}</span>
                                    @enderror
                                            ...
                                            <tr class="product-item">
                                                <td>
                                                    <div class="form-group">
                                                        <input type="text" readonly class="form-control bg-blue code"
                                                            name="code[]" value="{{ $price_quotation_product->code }}">
                                                        <input type="hidden" readonly
                                                            class="form-control company_branch_ids"
                                                            name="company_branch_ids[]"
                                                            value="{{ $price_quotation_product->company_branch_id }}">
                                                        <input type="hidden" class="form-control buy_price"
                                                            name="buy_price[]"
                                                            value="{{ $price_quotation_product->buy_price }}">
                                                    </div>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <input type="text" readonly class="form-control product"
                                                            name="product[]"
                                                            value="{{ $price_quotation_product->name }}">
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="form-group">
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <input type="text" class="form-control serial_no"
                                                            name="serial_no[]"
                                                            value="{{ $price_quotation_product->serial_no }}">
                                                    </div>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <input type="number" step="any"
                                                            class="form-control quantity" name="quantity[]"
                                                            value="{{ $price_quotation_product->quantity }}">
                                                    </div>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <input type="text" class="form-control unit_price"
                                                            name="unit_price[]"
                                                            value="{{ $price_quotation_product->unit_price }}">
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="form-group">
                                                        <input type="text" class="form-control product_discount"
                                                            ...
                                                            value="{{ $price_quotation_product->product_discount }}">
                                                        <input type="hidden" class="form-control product_tax"
                                                            name="product_tax[]"
                                                            value="{{ $price_quotation_product->tax_percentage }}">
                                                        <input type="hidden" class="form-control product_vat"
                                                            name="product_vat[]"
                                                            value="{{ $price_quotation_product->vat_percentage }}">
                                                    </div>
                                                </td>
                                    ...
                                    <tr>
                                        ...
                                        <th>
                                            <input type="text" id="discount" name="discount"
                                                value="{{ old('discount', $price_quotation->discount) }}"
                                    ...
                                    <tr>
                                        ...
                                        <th>
                                            <input type="text" readonly id="tax" name="tax"
                                                value="{{ old('tax', $price_quotation->tax) }}" class="form-control"
                                                autocomplete="off">
                                        </th>
                                        <td></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <th>
                                            <input type="text" readonly id="vat" name="vat"
                                                value="{{ old('vat', $price_quotation->vat) }}" class="form-control"
                                                autocomplete="off">
                                        </th>
                                        <td></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <th>
                                            <input type="text" readonly id="grand_total" name="grand_total"
                                                value="{{ old('grand_total', $price_quotation->total) }}"
                                                class="form-control">
                                        </th>
                                        <td></td>
                                    </tr>
