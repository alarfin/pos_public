...
@section('price_quotation_create', 'active')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form method="POST" action="{{ route('price_quotation_create') }}">
                    @csrf
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-3">
                                    ...
                                    <select class="form-control customer" name="customer" id="customer"
                                        ...
                                        @if (old('customer'))
                                            <option value="{{ old('customer') }}" selected>
                                                @php
                                                    $customer = App\Models\Customer::find(old('customer'));
                                                @endphp
                                    ...
                                    <tr>
                                        ...
                                        <th>
                                            <input type="text" readonly id="tax" name="tax"
                                                value="{{ old('tax', 0) }}" class="form-control" autocomplete="off">
                                        </th>
                                        <td></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <th>
                                            <input type="text" readonly id="vat" name="vat"
                                                value="{{ old('vat', 0) }}" class="form-control" autocomplete="off">
                                        </th>
                                        <td></td>
                                    </tr>
                                    <tr>
