...
@section('content')
    ...
    @endif
    <div class="row">
        <form method="POST" action="{{ route('online_expense_edit', ['online_expense' => $online_expense->id]) }}">
            @csrf
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title">Online expense</h3>
                    </div>
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-3">
                                        ...
                                        <select name="company_branch_id" id="company_branch_id"
                                            ...
                                            @foreach ($branches as $branch)
                                                <option value="{{ $branch->id }}"
                                                    @if (old('company_branch_id', $online_expense->company_branch_id) == $branch->id) selected @endif> {{ $branch->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="form-group {{ $errors->has('date') ? 'has-error' : '' }}">
                                    ...
                                    <div class="input-group date">
                                        ...
                                        <input type="text" class="form-control pull-right" id="date" name="date"
                                            value="{{ old('date', date('Y-m-d', strtotime($online_expense->date))) }}"
                                            autocomplete="off">
                                    </div>
                                    @error('date')
                                        <span class="help-block">{{ $message }}</span>
                                ...
                                <div class="form-group {{ $errors->has('payment_method') ? 'has-error' : '' }}">
                                    ...
                                    <div class="">
                                        <select name="payment_method" id="payment_method" class="form-control select2">
                                            <option value="1" @if (old('payment_method', $online_expense->company_branch_id) == 1) selected @endif> Cash
                                                In
                                                Hand </option>
                                            <option value="2" @if (old('payment_method', $online_expense->payment_method) == 2) selected @endif> Bank
                                            </option>
                                        </select>
                                    </div>
                                        ...
                                        <select name="bank_id" id="bank_id" class="form-control select2">
                                            ...
                                            @foreach ($banks as $bank)
                                                <option value="{{ $bank->id }}"
                                                    @if (old('bank_id', $online_expense->bank_id) == $bank->id) selected @endif>
                                        ...
                                        <select name="account_id" id="account_id" class="form-control select2">
                                            ...
                                            @foreach ($accounts as $account)
                                                <option value="{{ $account->id }}"
                                                    @if (old('account_id', $online_expense->account_id) == $account->id) selected @endif>
                                                    {{ $account->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-group {{ $errors->has('quantity') ? 'has-error' : '' }}">
                                    ...
                                    <div class="">
                                        <input type="text" class="form-control" id="quantity" name="quantity"
                                            value="{{ old('quantity', $online_expense->quantity) }}" autocomplete="off">
                                    </div>
                                    @error('quantity')
                                        <span class="help-block">{{ $message }}</span>
                                    @enderror
                                ...
                                <div class="form-group {{ $errors->has('amount') ? 'has-error' : '' }}">
                                    ...
                                    <div class="">
                                        <input type="text" class="form-control" id="amount" name="amount"
                                            value="{{ old('amount', $online_expense->amount) }}" autocomplete="off">
                                    </div>
                                    @error('quantity')
                                        <span class="help-block">{{ $message }}</span>
                                    @enderror
                                ...
                                <div class="form-group {{ $errors->has('note') ? 'has-error' : '' }}">
                                    ...
                                    <div class="">
                                        <input type="text" class="form-control" id="note" name="note"
                                            value="{{ old('note', $online_expense->note) }}" autocomplete="off">
                                    </div>
                                    @error('note')
                                        <span class="help-block">{{ $message }}</span>
                                    @enderror
