                    ...
                    <div id="print_area">
                        <div class="row">
                            ...
                            <div class="col-xs-4">
                                <div>
                                    <h3> Expense </h3>
                                    <b> Serial no: </b> {{ $online_expense->serial_no }} <br>
                                    <b> Date: </b> {{ $online_expense->date->format('d-m-Y') }} <br>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <table class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                        <td> {{ $online_expense->companyBranch->name ?? '' }} </td>
                                        <td> {{ $online_expense->account->name ?? '' }} </td>
                                        <td> {{ $online_expense->note }} </td>
                                        <td class="text-right"> {{ $online_expense->quantity }} </td>
                                        <td class="text-right"> {{ number_format($online_expense->amount, 2) }} </td>
                                    </tr>
                                </table>
                            </div>
                        </div>
