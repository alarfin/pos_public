...
@section('designation_add', 'active')
@section('title')
    Designation Add
@endsection
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form class="form-horizontal" method="POST" action="{{ route('designation_add') }}">
                    @csrf
                    <div class="box-body">
                        ...
                        <div class="form-group {{ $errors->has('short_name') ? 'has-error' :'' }}">
                            <label class="col-sm-2 control-label">Short Name <span class="text-danger">*</span> </label>
