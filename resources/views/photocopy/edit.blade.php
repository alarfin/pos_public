...
@section('content')
    ...
    @endif
    <div class="row">
        <form method="POST" action="{{ route('photocopy_edit', ['photocopy' => $photocopy->id]) }}">
            @csrf
            <div class="col-md-12">
                <div class="box">
                                        ...
                                        <select name="company_branch_id" id="company_branch_id"
                                            ...
                                            @foreach ($branches as $branch)
                                                <option value="{{ $branch->id }}"
                                                    @if (old('company_branch_id', $photocopy->company_branch_id) == $branch->id) selected @endif> {{ $branch->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group {{ $errors->has('customer_id') ? 'has-error' : '' }}">
                                    ...
                                    <select class="form-control customer" name="customer_id" id="customer"
                                        ...
                                        @if (old('customer_id', $photocopy->customer_id))
                                            <option value="{{ old('customer_id', $photocopy->customer_id) }}" selected>
                                                {{ App\Models\Customer::find(old('customer_id', $photocopy->customer_id))->name ?? '' }}
                                            </option>
                                        @endif
                                    </select>
                                ...
                                <div class="form-group {{ $errors->has('date') ? 'has-error' : '' }}">
                                    ...
                                    <div class="input-group date">
                                        ...
                                        <input type="text" class="form-control pull-right" id="date" name="date"
                                            value="{{ empty(old('date')) ? ($errors->has('date') ? '' : date('Y-m-d')) : old('date', $photocopy->date) }}"
                                            autocomplete="off">
                                    </div>
                                    @error('date')
                                        <span class="help-block">{{ $message }}</span>
                                ...
                                <div class="form-group {{ $errors->has('serial_no') ? 'has-error' : '' }}">
                                    ...
                                    <div class="">
                                        <input type="text" readonly class="form-control" id="serial_no" name="serial_no"
                                            value="{{ old('serial_no', $photocopy->serial_no) }}" autocomplete="off">
                                    </div>
                                    @error('serial_no')
                                        <span class="help-block">{{ $message }}</span>
                                    @enderror
                                ...
                                <div class="form-group {{ $errors->has('payment_method') ? 'has-error' : '' }}">
                                    ...
                                    <div class="">
                                        <select name="payment_method" id="payment_method" class="form-control select2">
                                            <option value="1" @if (old('payment_method', $photocopy->payment_method) == 1) selected @endif> Cash
                                                In
                                                Hand </option>
                                            <option value="2" @if (old('payment_method', $photocopy->payment_method) == 2) selected @endif> Bank
                                            </option>
                                        </select>
                                    </div>
                                        ...
                                        <select name="bank_id" id="bank_id" class="form-control select2">
                                            ...
                                            @foreach ($banks as $bank)
                                                <option value="{{ $bank->id }}"
                                                    @if (old('bank_id', $photocopy->bank_id) == $bank->id) selected @endif>
                                ...
                                <div class="form-group {{ $errors->has('quantity') ? 'has-error' : '' }}">
                                    ...
                                    <div class="">
                                        <input type="text" class="form-control" id="quantity" name="quantity"
                                            value="{{ old('quantity', $photocopy->quantity) }}" autocomplete="off">
                                    </div>
                                    @error('quantity')
                                        <span class="help-block">{{ $message }}</span>
                                    @enderror
                                ...
                                <div class="form-group {{ $errors->has('amount') ? 'has-error' : '' }}">
                                    ...
                                    <div class="">
                                        <input type="text" class="form-control" id="amount" name="amount"
                                            value="{{ old('amount', $photocopy->amount) }}" autocomplete="off">
                                    </div>
                                    @error('amount')
                                        <span class="help-block">{{ $message }}</span>
                                    @enderror
                                ...
                                <div class="form-group {{ $errors->has('extra_entry') ? 'has-error' : '' }}">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="extra_entry"
                                            ...
                                            @if (old('extra_entry', $photocopy->extra_entry) == 1) checked @endif />
