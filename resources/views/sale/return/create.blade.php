...
@section('sale_return_create', 'active')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box">
                ...
                <div class="box-body">
                    <form action="{{ route('sale_return') }}" method="GET">
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    <div class="">
                                        <input type="text" class="form-control" name="invoice_no" id="invoice_no"
                                            placeholder="Enter sale invoice no." autocomplete="off" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form method="POST" action="{{ route('sale_return') }}">
                        @csrf
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group {{ $errors->has('customer') ? 'has-error' : '' }}">
                                        ...
                                        <input type="text" name="customer"
                                            value="{{ old('customer', $sale_order->customer->name ?? '') }}"
                                ...
                                <div class="col-md-3">
                                    <div class="form-group {{ $errors->has('date') ? 'has-error' : '' }}">
                                        <label>Date </label>
                                        <input type="text" value="{{ old('date', $sale_order->date->format('Y-m-d')) }}"
                                            class="form-control" disabled>
                                        @error('date')
                                            <span class="help-block">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div class="form-group {{ $errors->has('invoice_no') ? 'has-error' : '' }}">
                                        ...
                                        <div class="">
                                            <input type="text" readonly class="form-control" id="invoice_no"
                                                name="invoice_no"
                                                value="{{ old('invoice_no', $sale_order->invoice_no) }}"
                                    ...
                                    <div class="form-group {{ $errors->has('payment_method') ? 'has-error' : '' }}">
                                        ...
                                        <div class="">
                                            <select name="payment_method" id="payment_method" class="form-control select2">
                                                @if ($sale_order->payment_method == 1)
                                    ...
                                    <div class="form-group {{ $errors->has('note') ? 'has-error' : '' }}">
                                        ...
                                        <div class="">
                                            <input type="text" class="form-control" id="note" name="note"
                                                value="{{ old('note', $sale_order->note) }}" autocomplete="off" disabled>
                                        </div>
                                        <!-- /.input group -->
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped">
                                    ...
                                    <tbody id="product-container">
                                        @foreach ($sale_order->products ?? [] as $order_product)
                                            <tr class="product-item">
                                                <td>
                                                    <div class="form-group">
                                                        <input type="hidden" name="sale_order_product_ids[]"
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <input type="text" class="form-control product_discount"
                                                            ...
                                                            value="{{ $order_product->product_discount }}" disabled>
                                                    </div>
                                                </td>
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <th colspan="8" class="text-right">Product Amount</th>
                                            <th id="total-amount">0.00</th>
                                        </tr>
                                        <tr>
                                            <th colspan="8" class="text-right"> Discount </th>
                                            <th>
                                                <input type="text" readonly id="discount" name="discount"
                                        ...
                                        <tr>
                                            ...
                                            <th>
                                                <input type="text" readonly id="tax" name="tax"
                                                    value="{{ old('tax', $sale_order->tax) }}" class="form-control"
                                                    autocomplete="off">
                                            </th>
                                        </tr>
                                        <tr>
                                            <th colspan="8" class="text-right"> Total VAT </th>
                                            <th>
                                                <input type="text" readonly id="vat" name="vat"
                                                    value="{{ old('vat', $sale_order->vat) }}" class="form-control"
                                                    autocomplete="off">
                                            </th>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <th colspan="8" class="text-right"> Paid </th>
                                            <th>
                                        ...
                                        <tr>
                                            <th colspan="8" class="text-right"> Customer Return Amount </th>
                                            <th>
    ...
    <script>
        ...
        function calculate() {
            ...
            $('.product-item').each(function(i, obj) {
                ...
                var current_quantity = parseFloat($('.quantity:eq(' + i + ')').val() || 0);
                var quantity = parseFloat(current_quantity - return_quantity);
                var unit_price = parseFloat($('.unit_price:eq(' + i + ')').val() || 0);
                var product_discount = parseFloat($('.product_discount:eq(' + i + ')').val() || 0);
                if (quantity == 0) {
                    $('.product_discount:eq(' + i + ')').val(0);
                    product_discount = 0;
                }
            ...
            var total_vat = parseFloat($('#vat').val() || 0);
