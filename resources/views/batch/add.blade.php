...
@section('content')
    ...
    @endif
    <div class="row">
        <form method="POST" action="{{ route('batch_add') }}" enctype="multipart/form-data">
            @csrf
            <div class="col-md-12">
                <div class="box">
                                        ...
                                        <div class="form-group {{ $errors->has('batch_no') ? 'has-error' : '' }}">
                                            ...
                                            <div class="">
                                                <input type="text" class="form-control" id="batch_no" name="batch_no"
                                                    value="{{ old('batch_no') }}" autocomplete="off">
                                            </div>
                                            @error('batch_no')
                                                <span class="help-block">{{ $message }}</span>
                                            @enderror
                                        ...
                                        <div class="form-group {{ $errors->has('seat') ? 'has-error' : '' }}">
                                            ...
                                            <div class="">
                                                <input type="number" class="form-control" id="seat" name="seat"
                                                    value="{{ old('seat', 0) }}" autocomplete="off">
                                            </div>
                                            @error('seat')
                                                <span class="help-block">{{ $message }}</span>
                                            @enderror
                                        ...
                                        <div class="form-group {{ $errors->has('status') ? 'has-error' : '' }}">
                                            ...
                                            <div class="">
                                                <select name="status" id="status" class="form-control select2">
                                                    ...
                                                    <option value="0"
                                                        @if (old('status', 1) == 0) selected @endif> Inactive
                                                    </option>
                                                </select>
                                            </div>
                                            @error('status')
