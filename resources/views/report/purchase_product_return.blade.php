...
@section('report_purchase_product_return', 'active')
@section('style')
    <!-- Select2 -->
...
@section('title')
    Purchase Product Return Report
@endsection
...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="box">
                <div class="box-body">
                    <form action="{{ route('report_purchase_product_return') }}">
                        <div class="row">
                            <div class="col-md-3">
                        ...
                        <table class="table table-bordered table-striped datatable">
                            ...
                            <tbody>
                                @foreach ($orders as $order)
                                    <tr>
                                        ...
                                        <td>{{ $order->return_at ? $order->return_at->format('j F, Y') : '' }}</td>
                                        ...
                                        <td class="text-right">{{ number_format($order->return_total, 2) }}</td>
                                    </tr>
                                @endforeach
                            </tbody>
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <td class="text-right">{{ number_format($orders->sum('return_quantity'), 2) }}
                                    </td>
                                    <td class="text-right">{{ number_format($orders->sum('return_total'), 2) }}</td>
                                </tr>
                            </tfoot>
                        </table>
                        <div class="row">
