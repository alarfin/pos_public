...
@section('report_purchase', 'active')
@section('style')
    <!-- Select2 -->
...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="box">
                <div class="box-body">
                    <form action="{{ route('report_purchase') }}">
                        <div class="row">
                            <div class="col-md-3">
                        ...
                        <table class="table table-bordered table-striped datatable">
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <td class="text-right">{{ number_format($orders->sum('paid'), 2) }}</td>
                                    <td class="text-right">{{ number_format($orders->sum('due'), 2) }}</td>
                                </tr>
                            </tfoot>
                        </table>
                        <div class="row">
