...
@section('report_trial_balance', 'active')
@section('style')
...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="box">
                <div class="box-body">
                    <form action="{{ route('report_trial_balance') }}">
                        <div class="row">
                            <div class="col-md-3">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right">
                                                        @if (in_array($account->account_class_id, [1, 4]))
                                                            {{ number_format($account->balance($searchData), 2) }}
                                                            @php
                                                                $total_debit += $account->balance($searchData);
                                                            @endphp
                                                        @endif
                                                    </td>
                                                    <td class="text-right">
                                                        @if (!in_array($account->account_class_id, [1, 4]))
                                                            {{ number_format($account->balance($searchData), 2) }}
                                                            @php
                                                                $total_credit += $account->balance($searchData);
                                                            @endphp
                                                        @endif
                                                    </td>
                                                    {{-- <td class="text-right">
