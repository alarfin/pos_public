...
@section('credit_transaction_add', 'active')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form method="POST" action="{{ route('credit_transaction_add') }}">
                    @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group {{ $errors->has('transaction_no') ? 'has-error' : '' }}">
                                    <label> credit Transaction No <span class="text-danger">*</span> </label>
                            ...
                            <div class="col-md-3">
                                <div class="form-group {{ $errors->has('payment_method') ? 'has-error' : '' }}">
                                    <label> Transaction Method (Debit) <span class="text-danger">*</span></label>
