...
@section('account_head_add', 'active')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form class="form-horizontal" method="POST" action="{{ route('account_head_add') }}">
                    @csrf
                            ...
                            <div class="col-sm-10">
                                <select class="form-control select2" name="account_class_id">
                                    ...
                                    @foreach ($account_classes as $account_class)
                                        <option value="{{$account_class->id}}" @if (old('account_class_id')==$account_class->id) selected @endif> {{$account_class->name}} </option>
                                    @endforeach
                                </select>
