...
@section('account_adjustment_add', 'active')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form method="POST" action="{{ route('account_adjustment_add') }}">
                    @csrf
                            ...
                            <table class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th width="20%"> Debit/Crtedit <span class="text-danger">*</span> </th>
                                        <th width="40%"> Note </th>
                                    ...
                                    @if (old('account_ids') != null && sizeof(old('account_ids')) > 0)
                                        @foreach (old('account_ids') as $item)
                                            <tr class="account-item">
                                                ...
                                                <td>
                                                    <div
                                                        class="form-group {{ $errors->has('types.' . $loop->index) ? 'has-error' : '' }}">
                                                        <select name="types[]" class="form-control select2 types">
                                                            <option value="1"> Debit/Withdraw </option>
                                                            <option value="2"
                                                                @if (old('types.' . $loop->index) == 2) selected @endif>
                                                                Credit/Deposit </option>
                                                        </select>
                                                    </div>
                                                </td>
                                                ...
                                                <td>
                                                    <div
                                                        ...
                                                        <input type="number" step="any" class="form-control amounts"
                                                            name="amounts[]" value="{{ old('amounts.' . $loop->index) }}">
                                                    </div>
                                                </td>
                                        ...
                                        <tr class="account-item">
                                            ...
                                            <td>
                                                <div class="form-group">
                                                    <select name="types[]" class="form-control select2 types">
                                                        <option value="1"> Debit/Withdraw </option>
                                                        <option value="2"> Credit/Deposit </option>
                                                    </select>
                                                </div>
                                            </td>
                                ...
                                <tfoot>
                                    <tr>
                                        <td>
                                            <a role="button" class="btn btn-info btn-sm" id="btn-add-account"> Add Account
                                            </a>
                                        </td>
