...
@section('supplier_opening_balance_add', 'active')
                    ...
                    <div class="box-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        <th width="20%"> Supplier name <span class="text-danger">*</span></th>
                                        <th width="20%"> Account name <span class="text-danger">*</span></th>
                                        <th width="40%"> Note </th>
                                    ...
                                    @if (old('account_ids') != null && sizeof(old('account_ids')) > 0)
                                        @foreach (old('account_ids') as $item)
                                            <tr class="account-item">
                                                <td>
                                                    <div
                                                        class="form-group {{ $errors->has('supplier_ids.' . $loop->index) ? 'has-error' : '' }}">
                                                        <select name="supplier_ids[]"
                                                            class="form-control select2 supplier_ids">
                                                            <option value=""> Select supplier </option>
                                                            @foreach ($suppliers as $supplier)
                                                                <option value="{{ $supplier->id }}"
                                                                    @if (old('supplier_ids.' . $loop->index) == $supplier->id) selected @endif>
                                        ...
                                        <tr class="account-item">
                                            <td>
                                                <div class="form-group">
                                                    <select name="supplier_ids[]" class="form-control select2 supplier_ids">
                                                        <option value=""> Select supplier </option>
                                                        @foreach ($suppliers as $supplier)
