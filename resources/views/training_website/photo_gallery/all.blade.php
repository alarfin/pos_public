...
@section('title')
    Training photo gallery informations
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box">
                <div class="box-body">
                    <a class="btn btn-primary" href="{{ route('training_photo_gallery_add') }}">Add photo gallery </a>
                    <hr>
    ...
    <script>
        $(function() {
            ...
            $('#table').DataTable({
                ...
                // "ordering": false,
                ajax: {
                    url: '{{ route('training_photo_galleries_datatable') }}',
                    data: function(d) {
                        d.test = '1'
                    }
                },
