...
@section('content')
    ...
    @endif
    <div class="row">
        <form method="POST" action="{{ route('training_photo_gallery_add') }}" enctype="multipart/form-data">
            @csrf
            <div class="col-md-12">
                <div class="box">
                        ...
                        <div class="row">
                                        ...
                                        <div class="form-group {{ $errors->has('sort') ? 'has-error' : '' }}">
                                            ...
                                            <div class="">
                                                <input type="text" class="form-control" id="sort" name="sort"
                                                    value="{{ old('sort', $sort + 1) }}" autocomplete="off" required>
                                            </div>
                                            @error('sort')
                                                <span class="help-block">{{ $message }}</span>
                                            @enderror
                            ...
                            <div class="col-md-6">
                                <div class="form-group {{ $errors->has('image') ? 'has-error' : '' }}">
                                    <label> Image <small>(800x500)</small> <span class="text-danger">*</span> </label>
                                    <div class="">
                                        <input type="file" class="form-control" id="image" name="image"
                                            value="{{ old('image') }}" autocomplete="off">
                                    </div>
                                    <div class="image">
                                        <img id="image_show" src="{{ asset('img/no_slider.png') }}" height="250"
                                            width="400" alt="image">
                                    </div>
                                    @error('image')
                                        <span class="help-block">{{ $message }}</span>
