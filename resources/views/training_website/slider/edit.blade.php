...
@section('content')
    ...
    @endif
    <div class="row">
        <form method="POST" action="{{ route('training_slider_edit', ['training_slider' => $training_slider->id]) }}"
                        ...
                        <div class="row">
                                        ...
                                        <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                                            ...
                                            <div class="">
                                                <input type="text" class="form-control" id="name" name="name"
                                                    value="{{ old('name', $training_slider->name) }}" autocomplete="off"
                                                    required>
                                            </div>
                                            @error('name')
                                        ...
                                        <div class="form-group {{ $errors->has('sort') ? 'has-error' : '' }}">
                                            ...
                                            <div class="">
                                                <input type="text" class="form-control" id="sort" name="sort"
                                                    value="{{ old('sort', $training_slider->sort) }}" autocomplete="off">
                                            </div>
                                            @error('sort')
                                                <span class="help-block">{{ $message }}</span>
                                            @enderror
                                        ...
                                        <div class="form-group {{ $errors->has('url') ? 'has-error' : '' }}">
                                            ...
                                            <div class="">
                                                <input type="text" class="form-control" id="url" name="url"
                                                    value="{{ old('url', $training_slider->url) }}" autocomplete="off">
                                            </div>
                                            @error('url')
                                                <span class="help-block">{{ $message }}</span>
                                            @enderror
                                        ...
                                        <div class="form-group {{ $errors->has('status') ? 'has-error' : '' }}">
                                            ...
                                            <div class="">
                                                <select name="status" id="status" class="form-control select2">
                                                    <option value="1"
                                                        @if (old('status', $training_slider->status) == 1) selected @endif>
                                                        Active </option>
                                                    <option value="0"
                                                        @if (old('status', $training_slider->status) == 0) selected @endif>
                                                        In-active
                                                    </option>
                                                </select>
                                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group {{ $errors->has('image') ? 'has-error' : '' }}">
                                    <label> Slider Image <small>(1350x450)</small><span class="text-danger">*</span>
                                    </label>
                                    <div class="">
                                    ...
                                    <div class="image">
                                        <img id="image_show"
                                            src="{{ $training_slider->image ? url($training_slider->image) : asset('img/no_slider.png') }}"
                                            height="150" width="100%" alt="image">
                                    </div>
                                    @error('image')
                                        <span class="help-block">{{ $message }}</span>
                                    @enderror
