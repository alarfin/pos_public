...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box">
                <div class="box-body">
                    <a class="btn btn-primary" href="{{ route('product_color_add') }}">Add Product Color </a>
                    <hr>
                                    ...
                                    <td>
                                        @can('product_color_edit')
                                            <a class="btn btn-info btn-sm"
                                                href="{{ route('product_color_edit', ['product_color' => $product_color->id]) }}">Edit</a>
                                        @endcan
                                        @can('product_color_delete')
                                            <a class="btn btn-danger btn-sm"
                                                href="{{ route('product_color_delete', ['product_color' => $product_color->id]) }}"
