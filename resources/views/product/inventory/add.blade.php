    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form class="form-horizontal" method="POST" action="{{ route('product_add') }}">
                    @csrf
                    ...
                    <div class="box-body">
                            ...
                            <div class="col-sm-10">
                                <select name="product_unit_id" id="product_unit_id" class="form-control select2">
                                    ...
                                    @foreach ($product_units as $product_unit)
                                        <option value="{{$product_unit->id}}" @if (old('product_unit_id')==$product_unit->id) selected @endif>{{ $product_unit->name }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group {{ $errors->has('buy_price') ? 'has-error' :'' }}">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" placeholder="Enter buy_price"
                                       name="buy_price" value="{{ old('buy_price', 0) }}">
                        ...
                        <div class="form-group {{ $errors->has('whole_sale_price') ? 'has-error' :'' }}">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" placeholder="Enter sale price"
                                       name="whole_sale_price" value="{{ old('whole_sale_price', 0) }}">
