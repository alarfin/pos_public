...
@section('content')
    ...
    <div class="row">
        <form method="POST"
            action="{{ route('online_information_edit', ['online_information' => $online_information->id]) }}">
            @csrf
            <div class="col-md-12">
                <div class="box">
                        ...
                        <div class="row">
                                        ...
                                        <select name="company_branch_id" id="company_branch_id"
                                            ...
                                            @foreach ($branches as $branch)
                                                <option value="{{ $branch->id }}"
                                                    @if (old('company_branch_id', $online_information->company_branch_id) == $branch->id) selected @endif> {{ $branch->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                            ...
                            <div class="col-md-2">
                                <div class="form-group {{ $errors->has('customer_id') ? 'has-error' : '' }}">
                                    ...
                                    <select class="form-control customer" name="customer_id" id="customer"
                                        ...
                                        @if (old('customer_id', $online_information->customer_id))
                                            <option value="{{ old('customer_id', $online_information->customer_id) }}"
                                                selected>
                                                {{ App\Models\Customer::find(old('customer_id', $online_information->customer_id))->name ?? '' }}
                                            </option>
                                        @endif
                                    </select>
                                ...
                                <div class="form-group {{ $errors->has('date') ? 'has-error' : '' }}">
                                    ...
                                    <div class="input-group date">
                                        ...
                                        <input type="text" class="form-control pull-right" id="date" name="date"
                                            value="{{ empty(old('date')) ? ($errors->has('date') ? '' : date('Y-m-d')) : old('date', $online_information->date) }}"
                                            autocomplete="off">
                                    </div>
                                    @error('date')
                                        <span class="help-block">{{ $message }}</span>
                                ...
                                <div class="form-group {{ $errors->has('serial_no') ? 'has-error' : '' }}">
                                    ...
                                    <div class="">
                                        <input type="text" readonly class="form-control" id="serial_no" name="serial_no"
                                            value="{{ old('serial_no', $online_information->serial_no) }}"
                                            autocomplete="off">
                                    </div>
                                    @error('serial_no')
                                        <span class="help-block">{{ $message }}</span>
                                        ...
                                        <select name="online_category_id" id="online_category_id"
                                            ...
                                            @foreach ($online_categories as $online_category)
                                                <option value="{{ $online_category->id }}"
                                                    @if (old('online_category_id', $online_information->online_category_id) == $online_category->id) selected @endif>
                                        ...
                                        <select name="application_type_id" id="application_type_id"
                                            ...
                                            @foreach ($application_types as $application_type)
                                                <option value="{{ $application_type->id }}"
                                                    @if (old('application_type_id', $online_information->application_type_id) == $application_type->id) selected @endif>
                                ...
                                <div class="form-group {{ $errors->has('payment_method') ? 'has-error' : '' }}">
                                    ...
                                    <div class="">
                                        <select name="payment_method" id="payment_method" class="form-control select2">
                                            <option value="1" @if (old('payment_method', $online_information->payment_method) == 1) selected @endif> Cash
                                                In
                                                Hand </option>
                                            <option value="2" @if (old('payment_method', $online_information->payment_method) == 2) selected @endif> Bank
                                            </option>
                                        </select>
                                    </div>
                                        ...
                                        <select name="bank_id" id="bank_id" class="form-control select2">
                                            ...
                                            @foreach ($banks as $bank)
                                                <option value="{{ $bank->id }}"
                                                    @if (old('bank_id', $online_information->bank_id) == $bank->id) selected @endif>
                                ...
                                <div class="form-group {{ $errors->has('quantity') ? 'has-error' : '' }}">
                                    ...
                                    <div class="">
                                        <input type="text" class="form-control" id="quantity" name="quantity"
                                            value="{{ old('quantity', $online_information->quantity) }}"
                                            autocomplete="off">
                                    </div>
                                    @error('quantity')
                                        <span class="help-block">{{ $message }}</span>
                                ...
                                <div class="form-group {{ $errors->has('total') ? 'has-error' : '' }}">
                                    ...
                                    <div class="">
                                        <input type="text" class="form-control" id="total" name="total"
                                            value="{{ old('total', $online_information->total) }}" autocomplete="off">
                                    </div>
                                    @error('total')
                                        <span class="help-block">{{ $message }}</span>
                                    @enderror
                            ...
                            <div class="col-md-2">
                                <div class="form-group {{ $errors->has('paid') ? 'has-error' : '' }}">
                                    ...
                                    <div class="">
                                        <input type="text" readonly class="form-control" id="paid"
                                            name="paid" value="{{ old('paid', $online_information->paid) }}"
                                            autocomplete="off">
                                    </div>
                                    @error('paid')
                                        <span class="help-block">{{ $message }}</span>
                            ...
                            <div class="col-md-2">
                                <div class="form-group {{ $errors->has('due') ? 'has-error' : '' }}">
                                    ...
                                    <input type="number" step="any"
                                        value="{{ old('due', $online_information->due) }}" class="form-control"
                                        id="due" name="due" autocomplete="off" disabled required>
                                    @error('due')
                                        <span class="help-block">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group {{ $errors->has('fee_payment') ? 'has-error' : '' }}">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="fee_payment"
                                            ...
                                            @if (old('fee_payment', $online_information->fee_payment) == 1) checked @endif />
                                ...
                                <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                                    ...
                                    <div class="">
                                        <input type="text" class="form-control" id="name" name="name"
                                            value="{{ old('name', $online_information->name) }}" autocomplete="off">
                                    </div>
                                    @error('name')
                                        <span class="help-block">{{ $message }}</span>
                                    @enderror
                                ...
                                <div class="form-group {{ $errors->has('mobile_no') ? 'has-error' : '' }}">
                                    ...
                                    <div class="">
                                        <input type="text" class="form-control" id="mobile_no" name="mobile_no"
                                            value="{{ old('mobile_no', $online_information->mobile_no) }}"
                                            autocomplete="off">
                                    </div>
                                    @error('mobile_no')
                                        <span class="help-block">{{ $message }}</span>
                                ...
                                <div class="form-group {{ $errors->has('nid_no') ? 'has-error' : '' }}">
                                    ...
                                    <div class="">
                                        <input type="text" class="form-control" id="nid_no" name="nid_no"
                                            value="{{ old('nid_no', $online_information->nid_no) }}"
                                            autocomplete="off">
                                    </div>
                                    @error('nid_no')
                                        <span class="help-block">{{ $message }}</span>
                                ...
                                <div class="form-group {{ $errors->has('note') ? 'has-error' : '' }}">
                                    ...
                                    <div class="">
                                        <input type="text" class="form-control" id="note" name="note"
                                            value="{{ old('note', $online_information->note) }}" autocomplete="off">
                                    </div>
                                    @error('note')
                                        <span class="help-block">{{ $message }}</span>
                                    @enderror
