...
@section('content')
    ...
    @endif
    <div class="row">
        <form method="POST" action="{{ route('course_add') }}" enctype="multipart/form-data">
            @csrf
            <div class="col-md-12">
                <div class="box">
                        ...
                        <div class="row">
                                                ...
                                                <select name="course_category_id" id="course_category_id"
                                                    ...
                                                    @foreach ($course_categories as $course_category)
                                                        <option value="{{ $course_category->id }}"
                                                            @if (old('course_category_id') == $course_category->id) selected @endif>
                                        ...
                                        <div class="form-group {{ $errors->has('status') ? 'has-error' : '' }}">
                                            ...
                                            <div class="">
                                                <select name="status" id="status" class="form-control select2">
                                                    <option value="1"
                                                        @if (old('status', 1) == 1) selected @endif> Active </option>
                                                    <option value="0"
                                                        @if (old('status', 1) == 0) selected @endif> In-active
                                                    </option>
                                                </select>
                                            </div>
                                            @error('status')
                            ...
                            <div class="col-md-4">
                                <div class="form-group {{ $errors->has('image') ? 'has-error' : '' }}">
                                    ...
                                    <div class="image">
                                        <img id="image_show" src="{{ asset('img/no_image.png') }}" alt="Image">
                                    </div>
                                    @error('image')
                                        <span class="help-block">{{ $message }}</span>
                                    @enderror
