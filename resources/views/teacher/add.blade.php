...
@section('content')
    ...
    @endif
    <div class="row">
        <form method="POST" action="{{ route('teacher_add') }}" enctype="multipart/form-data">
            @csrf
            <div class="col-md-12">
                <div class="box">
                                                ...
                                                <select name="designation_id" id="designation_id"
                                                    ...
                                                    @foreach ($designations as $designation)
                                                        <option value="{{ $designation->id }}"
                                                            @if (old('designation_id') == $designation->id) selected @endif>
                                                            {{ $designation->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="form-group {{ $errors->has('education') ? 'has-error' : '' }}">
                                            ...
                                            <div class="">
                                                <input type="text" class="form-control" id="education" name="education"
                                                    value="{{ old('education') }}" autocomplete="off">
                                            </div>
                                            @error('education')
                                                <span class="help-block">{{ $message }}</span>
                                            @enderror
                                        ...
                                        <div class="form-group {{ $errors->has('short_bio') ? 'has-error' : '' }}">
                                            ...
                                            <div class="">
                                                <input type="text" class="form-control" id="short_bio" name="short_bio"
                                                    value="{{ old('short_bio') }}" autocomplete="off">
                                            </div>
                                            @error('short_bio')
                                                <span class="help-block">{{ $message }}</span>
                                            @enderror
